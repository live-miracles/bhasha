...
const SAFE_DISCONNECT_REASONS = ['client_disconnect', 'language_switch', 'reconnected'] as const;
 ...
 */
export function isDropoutEvent(eventType: string, reason: string | null): boolean {
...
export function parseMetadataObject(value: string | null): Record<string, unknown> | null {
    if (value === null) {
        return null;
    }
    try {
