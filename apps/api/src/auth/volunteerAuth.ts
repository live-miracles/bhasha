import { VolunteerRepository, type VolunteerSessionRecord } from '../db/volunteerRepository';
...
export function requireVolunteerService(env: Env): { sessionSecret: string } | Response {
...
export async function requireVolunteerSession(
    request: Request,
    env: Env,
    repository = new VolunteerRepository(env.DB, env.TRANSLATOR_PASSWORD_PEPPER),
