...
type ParticipantMetadata = TranslatorParticipantMetadata | ListenerParticipantMetadata;
...
async function resolveParticipantMetadata(
    ...
    return parseParticipantMetadataFields(participant.metadata, participant.identity, event.event);
}
