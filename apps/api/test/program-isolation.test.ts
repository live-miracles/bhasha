...
const ENDPOINT_CASES: EndpointCase[] = [
  ...
  },
  {
    ...
    write: false,
    path: ({ programId }) =>
      `/api/admin/programs/${programId}/listener-access/summary`
  },
  {
    ...
    write: true,
    path: ({ programId }) =>
      `/api/admin/programs/${programId}/listener-access/revoke`
  },
  {
  ...
  {
    name:
      "DELETE /api/admin/programs/:id/translators/:tid/sessions/:sid",
    method: "DELETE",
    write: true,
  ...
  {
    name:
      "POST /api/admin/programs/:id/streams/:sid/kick-publisher",
    method: "POST",
    write: true,
  ...
  {
    name:
      "DELETE /api/admin/programs/:id/translators/:tid/assignments/:aid",
    method: "DELETE",
    write: true,
