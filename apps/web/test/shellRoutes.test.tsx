...
import type { PublicApi, PublicProgramMetadata, PublicProgramStatus } from '../src/api/public';
...
describe('App route shells', () => {
    ...
    it('renders loading then listener metadata and status success', async () => {
        ...
        render(<App path="/patna-event-2026" publicApi={{ fetchProgram, fetchProgramStatus }} />);
    ...
    it('renders listener empty metadata state', async () => {
        ...
        render(<App path="/patna-event-2026" publicApi={publicApi} />);
    ...
    it('renders translator shell login with the decoded slug', async () => {
        ...
        expect(screen.getByRole('main', { name: 'Translator shell' })).toBeInTheDocument();
        expect(
