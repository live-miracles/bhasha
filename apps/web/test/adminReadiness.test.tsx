...
describe('ReadinessPanel', () => {
    it('renders the readiness heading and each item with its status', () => {
        ...
        expect(within(region).getByText('Confirmed at 21 Jun 2026, 15:30:00 IST')).toBeTruthy();
    });
    ...
    it('renders confirm buttons only for smoke and mobile field checks', () => {
        ...
        expect(screen.queryByRole('button', { name: /confirm language streams/i })).toBeNull();
        expect(screen.queryByRole('button', { name: /confirm turn analytics/i })).toBeNull();
    });
