import type { AdminEventFeed, AdminEventFeedEntry, AdminProgramDetail } from '../../../api/admin';
...
export function EventFeedPanel({
    ...
    const filtersActive = filters.eventTypes.length > 0 || filters.translatorId !== '';
    ...
    return (
        <section aria-label="Recent events" className="admin-subsection">
            ...
            >
                ...
                {feed !== null && feed.events.length === 0 ? <p>No recent events.</p> : null}
